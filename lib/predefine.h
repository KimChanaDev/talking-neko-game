...
PixelImg img_confused("img/confused.txt");
PixelImg img_cry("img/cry.txt");
PixelImg img_drunk("img/drunk.txt");
PixelImg img_normal("img/normal.txt");
PixelImg img_readbook("img/readbook.txt");
